...
class CelebrationWidget extends ConsumerWidget {
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: _buildSafeAvatar(img, context),
                    ),
  ...
  Widget _buildSafeAvatar(String? imageUrl, BuildContext context) {
    const double radius = 24;

    if (imageUrl == null || imageUrl.isEmpty || imageUrl.contains('default-user')) {
