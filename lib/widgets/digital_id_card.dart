...
class DigitalIDCard extends StatelessWidget {
  ...
  Widget _buildAvatarImage(String url, double size, BuildContext context) {
    if (url.isEmpty || url.contains('default-user')) {
                          ...
                          Column(
                            children: [
                              Container(
                                ...
                                child: ClipOval(
                                  child: _buildAvatarImage(imageUrl, avatarSize, context),
                                ),
                              ),
