...
class _CallLogsTabState extends ConsumerState<CallLogsTab> {
  ...
  void _setupSocketListeners() {
    _socketService.callEvents.listen((event) {
      ...
      if (event['type'] == 'call_ended_remote' || event['type'] == 'call_failed') {
        ...
        itemBuilder: (context, index) {
          ...
          return Dismissible(
            ...
            child: ListTile(
              ...
              // ✅ FIX: Added long-press feature to trigger the delete popup
              onLongPress: () {
                showDialog(
                  context: context,
                  builder: (ctx) => AlertDialog(
                    title: const Text("Delete Call Log"),
                    content: const Text("Are you sure you want to remove this call from your history?"),
                    actions: [
                      TextButton(
